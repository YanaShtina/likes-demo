...
/* harmony default export */ var modules_gsap = ({
  initHero: function initHero() {
    var tlDots = gsapWithCSS.timeline({
      repeat: -1
    });
    tlDots.to('._bg-dots', {
      rotationZ: -10,
    ...
    var tlLeft1 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlLeft1.to(leftItem1, {
      y: -10,
      duration: 4,
      scale: 0.7
    }).to(leftItem1, {
    ...
    //2
    var leftItem2 = document.querySelector('._left-2');
    var tlLeft2 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlLeft2.to(leftItem2, {
      y: 10,
      x: 10,
      duration: 4,
      scale: 1.2
    ...
    //3
    var leftItem3 = document.querySelector('._left-3');
    var tlLeft3 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlLeft3.to(leftItem3, {
      y: -20,
      x: -20,
      duration: 4,
      scale: 1.2,
    ...
    //3
    var leftItem4 = document.querySelector('._left-4');
    var tlLeft4 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlLeft4.to(leftItem4, {
      y: 10,
      x: 10,
      duration: 4,
      scale: 0.7,
    ...
    var rightItem1 = document.querySelector('._right-1');
    var tlright1 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlright1.to(rightItem1, {
      y: -10,
      duration: 4,
      scale: 0.7
    }).to(rightItem1, {
    ...
    var rightItem2 = document.querySelector('._right-2');
    var tlright2 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlright2.to(rightItem2, {
      y: -10,
      duration: 4,
      scale: 0.7
    }).to(rightItem2, {
    ...
    var rightItem3 = document.querySelector('._right-3');
    var tlright3 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlright3.to(rightItem3, {
      y: -10,
      duration: 4,
      scale: 0.7
    }).to(rightItem3, {
    ...
    var rightItem4 = document.querySelector('._right-4');
    var tlright4 = gsapWithCSS.timeline({
      repeat: -1
    });
    tlright4.to(rightItem4, {
      y: -10,
      duration: 4,
      scale: 0.7
    }).to(rightItem4, {
  ...
  initRocket: function initRocket() {
    // если тру - значит мобилка
    var mql = window.matchMedia("(max-width: 700px)");
    var text = gsapWithCSS.timeline({
      repeat: -1
    });

    // анимация текста 
    var changeColor = document.querySelector('.rocket__info-inner .animated');
    var tlchangeColor = gsapWithCSS.timeline({
      repeat: -1
    });
    tlchangeColor.to(changeColor, {
      color: '#ffffff',
    ...
    if (mql.matches != true) {
      ...
      _tl.to(".rocket__item._1 .icon, .rocket__item._1 .text", {
        opacity: 0
      }).to(".rocket__item._1 .icon, .rocket__item._1 .text", {
        opacity: 1
      });
      _tl.to(".rocket__item._2 .icon, .rocket__item._2 .text", {
        opacity: 0
      }).to(".rocket__item._2 .icon, .rocket__item._2 .text", {
        opacity: 1
      });
      _tl.to(".rocket__item._3 .icon, .rocket__item._3 .text", {
        opacity: 0
      }).to(".rocket__item._3 .icon, .rocket__item._3 .text", {
        opacity: 1
      });
      _tl.to(".rocket__item._4 .icon, .rocket__item._4 .text", {
        opacity: 0
      }).to(".rocket__item._4 .icon, .rocket__item._4 .text", {
        opacity: 1
      });
      _tl.to(".rocket__item._5 .icon, .rocket__item._5 .text", {
        opacity: 0
      }).to(".rocket__item._5 .icon, .rocket__item._5 .text", {
        opacity: 1
      });
  ...
  scrollResults: function scrollResults() {
    ...
    if (mql.matches != true) {
      ...
      var scroll4 = document.querySelector('.scroll-4');
      var scroll5 = document.querySelector('.scroll-5');
      var tl = gsapWithCSS.timeline();
      tl.to(scroll2, {
        top: 0,
        duration: 3
  ...
  more: function more() {
    var moreOut = document.querySelectorAll('.out');
    var moreOut1 = document.querySelector('.how__screen-anim');
    var reason = document.querySelector('.reasons__img .svg');
    var tl = gsapWithCSS.timeline({
      repeat: -1
    });
...
;// CONCATENATED MODULE: ./src/modules/sliders.js

/* harmony default export */ var sliders = ({
  initReviews: function initReviews() {
    var swiper = new core('.swiper.reviews__slider', {
  ...
  initTop: function initTop() {
    var swiper = new core('.swiper.top', {
      modules: [Navigation, Pagination, Autoplay, EffectFade],
      loop: true,
      speed: 500,
      spaceBetween: 12,
...
/* harmony default export */ var counter = ({
  init: function init() {
    var span = document.querySelector('.counter .number');
